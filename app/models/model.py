...
class CreditRiskModel:
    ...
    def load_model(self, model_path: str):
        ...
        try:
            ...
            logger.warning(f"Model file {model_path} not found. Using default mappings.")
            self._initialize_woe_mappings()
    ...
    def predict_score(self, input_data: Dict) -> Dict:
        ...
        try:
            ...
            # Calculate WOE features
            woe_features = self._calculate_woe_features(processed_data)
            ...
            for feature, coef in self.model_coefficients.items():
                ...
                woe_value = self._get_woe_value(base_feature, processed_data.get(base_feature, 0))
            ...
            offset = self.scoring_params['BaseScore'] - factor * np.log(self.scoring_params['BaseOdds'])
    ...
    def _preprocess_input(self, data: Dict) -> Dict:
        ...
        if 'loan_burden' not in processed and 'annual_inc' in processed:
            ...
            estimated_loan_amount = processed.get('loan_amount', 15000)  # Default estimate
            processed['loan_burden'] = estimated_loan_amount / (processed['annual_inc'] + 1)
    ...
    def validate_input(self, input_data: Dict) -> Tuple[bool, List[str]]:
        ...
        if 'int_rate' in input_data and (input_data['int_rate'] < 0 or input_data['int_rate'] > 50):
