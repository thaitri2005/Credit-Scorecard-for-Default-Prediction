...
class TestDataPreprocessor:
    ...
    def test_loan_status_mapping(self):
        ...
        assert preprocessor.map_loan_status("Issued") is None
        assert preprocessor.map_loan_status("In Grace Period") is None
...
class TestModelIntegration:
    ...
    def test_end_to_end_prediction(self):
        ...
        for test_case in test_cases:
            ...
            # Validate risk level
            assert result["risk_level"] in ["Low Risk", "Medium Risk", "High Risk", "Very High Risk"]
    ...
    def test_model_consistency(self):
        ...
        for i in range(1, len(results)):
            ...
            assert results[i]["default_probability"] == results[0]["default_probability"]
